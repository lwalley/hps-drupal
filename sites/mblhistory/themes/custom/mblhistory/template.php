 ...
 *   mblhistory_. For example:
 *
 *     original, found in modules/field/field.module: theme_field()
 *     theme override, found in template.php: mblhistory_field()
 *
 *   where mblhistory is the name of your sub-theme. For example, the
...
function mblhistory_preprocess_maintenance_page(&$variables, $hook) {
  // When a variable is manipulated or added in preprocess_html or
  // preprocess_page, that same work is probably needed for the maintenance page
  // as well, so we can just re-use those functions to do that work here.
  mblhistory_preprocess_html($variables, $hook);
  mblhistory_preprocess_page($variables, $hook);
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function mblhistory_preprocess_html(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function mblhistory_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function mblhistory_preprocess_region(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function mblhistory_preprocess_block(&$variables, $hook) {
